...
pub use forms::{
    ...
    Input1098E, Input1098T, Input1099B, Input1099Div, Input1099G, Input1099Int, Input1099K,
    Input1099Misc, Input1099Nec, Input1099Oid, Input1099Patr, Input1099R, Input1120SScheduleK1,
    InputForm, InputW2, InputW2G, Output965A, Output1040, Output1040Nr, Output1040Sr, Output1042S,
